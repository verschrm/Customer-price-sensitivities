...
# Load results from Frontier_Discrete_XGBoost.R
...
NLP_obj_con_i_tau <- function(Offers, P_Old, Offer_Grid, Data_i_tau, Ind_t, Churn_Model, 
  ...
  Churn_i_1 <- Churn_Pred_i_1(Churn_Model = Churn_XGB, 
                              Cat_Offer = as.character(Cat_Offers[Ind_t[[1]]]), 
                              Data_i_1 = Data_i_tau[Ind_t[[1]], ])
  Churn_i_2 <- Churn_Pred_Adj_i_1(P_Old = P_Old_2, Churn_Model = Churn_XGB, 
                                  Cat_Offer = as.character(Cat_Offers[Ind_t[[2]]]), 
                                  Data_i_1 = Data_i_tau[Ind_t[[2]], ])
  Churn_i_3 <- Churn_Pred_Adj_i_1(P_Old = P_Old_3, Churn_Model = Churn_XGB, 
...
Churn_i_1 <- t(sapply(1:T_max, function(t_1)
  Churn_Pred_i_1(Churn_Model = Churn_XGB, Cat_Offer = as.character(t_1), Data_i_1 = Data_i_1)))
...
Churn_Act_1 <- Churn_Pred_i_1(Churn_Model = Churn_XGB, 
...
for (t_1 in 1:T_max) {
  ...
  Churn_i_2 <- t(sapply(1:T_max, function(t_2) 
    Churn_Pred_Adj_i_1(P_Old = P_Old_2, Churn_Model = Churn_XGB, 
  ...
  for (t_2 in 1:T_max) {
    ...
    Churn_i_3 <- t(sapply(1:T_max, function(t_3) 
      Churn_Pred_Adj_i_1(P_Old = P_Old_3, Churn_Model = Churn_XGB, 
...
# Churn
Churn_LP_1 <- Churn_Pred_i_1(Churn_Model = Churn_XGB, Cat_Offer = as.character(Ind_LP_1), 
                             Data_i_1 = Data_i_1)
Churn_LP_2 <- Churn_Pred_Adj_i_1(P_Old = P_Old_Base * (1 + Results_Offers_1[1, ]), 
                                 Churn_Model = Churn_XGB, Cat_Offer = as.character(Ind_LP_2),
                                 Data_i_1 = Data_i_2)
Churn_LP_3 <- Churn_Pred_Adj_i_1(P_Old = P_Old_Base * (1 + Results_Offers_1[1, ]) *
                                   (1 + Results_Offers_1[2, ]), 
                                 Churn_Model = Churn_XGB, Cat_Offer = as.character(Ind_LP_3),
                                 Data_i_1 = Data_i_3)
# Profit
Profit_LP <- list()
...
# Churn
Churn_NLP_1 <- Churn_Pred_i_1(Churn_Model = Churn_XGB, 
...
Churn_i_3 <- t(sapply(1:T_max, function(t)
  Churn_Pred_Adj_i_1(P_Old = P_Old_Base * (1 + Offer_Grid[NLP_sol[Ind_t_1]]) *
                       (1 + Offer_Grid[NLP_sol[Ind_t_2]]), 
                     Churn_Model = Churn_XGB, Cat_Offer = as.character(t), 
                     Data_i_1 = Data_i_3)))
...
Churn_i_3 <- t(sapply(1:T_max, function(t)
  Churn_Pred_Adj_i_1(P_Old = P_Old_Base * (1 + Offer_Grid[NLP_sol[Ind_t_1]]) * (1 + Offer_Grid[t]), 
                     Churn_Model = Churn_XGB, Cat_Offer = as.character(LP_extra_3[2, ]), 
                     Data_i_1 = Data_i_3)))
...
Churn_i_1 <- t(sapply(1:T_max, function(t)
  Churn_Pred_i_1(Churn_Model = Churn_XGB, Cat_Offer = as.character(t), Data_i_1 = Data_i_1)))
Churn_i_2 <- t(sapply(1:T_max, function(t)
  Churn_Pred_Adj_i_1(P_Old = P_Old_Base * (1 + Offer_Grid[t]), Churn_Model = Churn_XGB, 
...
Churn_i_2 <- t(sapply(1:T_max, function(t)
  Churn_Pred_Adj_i_1(P_Old = P_Old_Base * (1 + LP_extra_1[3, ]), 
                     Churn_Model = Churn_XGB, Cat_Offer = as.character(t), Data_i_1 = Data_i_2)))
Churn_i_3 <- t(sapply(1:T_max, function(t)
...
Churn_i_3 <- t(sapply(1:T_max, function(t)
  Churn_Pred_Adj_i_1(P_Old = P_Old_Base * (1 + LP_extra_1[3, ]) * (1 + LP_2_extra_2[3, ]), 
                     Churn_Model = Churn_XGB, Cat_Offer = as.character(t), Data_i_1 = Data_i_3)))
...
Churn_i_3 <- t(sapply(1:T_max, function(t)
  Churn_Pred_Adj_i_1(P_Old = P_Old_Base * (1 + LP_extra_1[3, ]) * (1 + Offer_Grid[t]), 
                     Churn_Model = Churn_XGB, Cat_Offer = as.character(LP_2_extra_3[2, ]), 
                     Data_i_1 = Data_i_3)))
P_Old_2 <- P_Old_Base * (1 + LP_extra_1[3, ])
...
Churn_i_2 <- Churn_Pred_Adj_i_1(P_Old = P_Old_Base * (1 + LP_2_extra_1[3, ]), 
                                Churn_Model = Churn_XGB, Cat_Offer = as.character(LP_4_extra_2[2, ]), 
                                Data_i_1 = Data_i_2)
Churn_i_3 <- t(sapply(1:T_max, function(t)
...
Churn_i_3 <- t(sapply(1:T_max, function(t)
  Churn_Pred_Adj_i_1(P_Old = P_Old_Base * (1 + LP_2_extra_1[3, ]) * (1 + Offer_Grid[t]), 
                     Churn_Model = Churn_XGB, Cat_Offer = as.character(LP_3_extra_3[2, ]), 
                     Data_i_1 = Data_i_3)))
P_Old_2 <- P_Old_Base * (1 + LP_2_extra_1[3, ])
...
# Period 1
Churn_i_1 <- t(sapply(1:T_max, function(t)
  Churn_Pred_i_1(Churn_Model = Churn_XGB, Cat_Offer = as.character(t), 
                 Data_i_1 = Data_i_1)))
Churn_i_2 <- t(sapply(1:T_max, function(t)
  Churn_Pred_Adj_i_1(P_Old = P_Old_Base * (1 + Offer_Grid[t]), Churn_Model = Churn_XGB, 
...
Churn_i_3 <- t(sapply(1:T_max, function(t)
  Churn_Pred_Adj_i_1(P_Old = P_Old_Base * (1 + LP_3_extra_1[3, ]) * (1 + Offer_Grid[t]), 
                     Churn_Model = Churn_XGB, Cat_Offer = as.character(LP_4_extra_3[2, ]), 
                     Data_i_1 = Data_i_3)))
P_Old_2 <- P_Old_Base * (1 + LP_3_extra_1[3, ])
...
# Churn
Churn_LP_Add_1 <- Churn_Pred_i_1(Churn_Model = Churn_XGB, 
